...
// Renders the app shell — hides the global Header on the landing page
function AppLayout() {
  ...
  return (
    <div className="min-h-screen bg-light-bg dark:bg-dark-bg transition-colors duration-200">
      ...
      <Toaster
        ...
        reverseOrder={false}
        gutter={8}
        containerStyle={{ top: isLanding ? 16 : 72 }}
        toastOptions={{
          duration: 4000,
          style: { maxWidth: '90vw', fontSize: '0.875rem' },
          success: { duration: 3000, style: { background: '#537D5D', color: '#fff' } },
