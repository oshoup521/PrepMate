            ...
            {currentUser ? (
              ...
              <div className="flex items-center gap-1">
                <button
                  ...
                  className="px-3 py-1.5 text-sm font-medium text-light-text/70 dark:text-dark-text/70 hover:text-light-text dark:hover:text-dark-text transition-colors rounded-lg hover:bg-light-border/50 dark:hover:bg-dark-border/50"
                >
                  Sign In
                </button>
                <button
                  onClick={() => navigate('/register')}
                  className="px-3 py-1.5 text-sm font-medium text-white bg-forest dark:bg-sage rounded-lg hover:bg-olive dark:hover:bg-sand transition-colors"
                >
                  Sign Up
                </button>
              </div>
